...
class ViewerServerTests(unittest.TestCase):
    ...
    def test_serves_application_and_model(self) -> None:
        with urlopen(f"{self.base_url}/") as response:
            ...
            self.assertIn(b'id="player-select-list"', application)
            self.assertIn(b'id="vision-coloring-toggle"', application)
            self.assertIn(b'id="gap-coloring-toggle"', application)
            self.assertIn(b'id="playback-vision-toggle"', application)
            self.assertIn(b'id="playback-gap-toggle"', application)
        ...
        with urlopen(f"{self.base_url}/renderer.js") as response:
            ...
            self.assertIn(b"setFaceColors(faceColors)", renderer)
